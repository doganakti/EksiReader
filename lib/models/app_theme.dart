...
class AppTheme {
  ...
  static ThemeData light() {
    ...
    var themeData = ThemeData(
        ...
        // Color(0xff1da1f2)
        brightness: brightness,
        primaryColor: brightness == Brightness.dark ? Color(0xff303030) : Color(0xfff6f1e6),
        primarySwatch: brightness == Brightness.dark ? Colors.blueGrey : Colors.blueGrey,
        accentColor: brightness == Brightness.dark ? Colors.orange : Colors.black87,
        scaffoldBackgroundColor: brightness == Brightness.dark ? Color(0xff303030) : Color(0xfff6f1e6),
        floatingActionButtonTheme: FloatingActionButtonThemeData(
          backgroundColor:brightness == Brightness.dark ? Color(0xff303030) : Colors.blueGrey, 
          foregroundColor: Colors.white,
        ...
        appBarTheme: AppBarTheme(textTheme: TextTheme(title: TextStyle(fontSize: 18, color: brightness == Brightness.dark ? Colors.white : Colors.black, fontWeight: FontWeight.w500))),
        ...
        textTheme: TextTheme(
            ...
            display3: TextStyle(
                color: brightness == Brightness.dark ? Colors.orangeAccent : Color(0xffa16523),
                fontSize: 15,
                fontWeight: brightness == Brightness.dark ? FontWeight.w400 : FontWeight.w500),
